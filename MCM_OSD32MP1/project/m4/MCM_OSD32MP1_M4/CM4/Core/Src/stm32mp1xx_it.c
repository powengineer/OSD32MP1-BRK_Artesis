...
/* External variables --------------------------------------------------------*/
extern DMA_HandleTypeDef hdma_dfsdm1_flt4;
extern DMA_HandleTypeDef hdma_dfsdm1_flt5;
...
void DMA2_Stream4_IRQHandler(void)
{
  ...
  HAL_DMA_IRQHandler(&hdma_dfsdm1_flt4);
...
void DMA2_Stream5_IRQHandler(void)
{
  ...
  HAL_DMA_IRQHandler(&hdma_dfsdm1_flt5);
